...
public:
	...
	virtual void AddTickSignal(VPANEL panel, int intervalMilliseconds = 0 ) = 0; // WHY THE HELL IS int intervalMilliseconds = 0???
	
	//virtual void AddTickSignal(VPANEL panel, int intervalMilliseconds = 17) = 0; // 60 fps
