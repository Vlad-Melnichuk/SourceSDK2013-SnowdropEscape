...
void CBaseViewModel::CalcIronsights(Vector &pos, QAngle &ang)
{
	...
	float delta = (gpGlobals->curtime - pWeapon->m_flIronsightedTime) * 4.2f; //modify this value to adjust how fast the interpolation is
...
// Purpose: 
//-----------------------------------------------------------------------------
float g_fMaxViewModelLag = 0.5f; //тут было 1,5

//проверить и фиксануть
