...
BEGIN_SEND_TABLE_NOBASE( CHL2PlayerLocalData, DT_HL2Local )
	...
	SendPropBool( SENDINFO(m_SMG1_GL_Loaded) ),
	SendPropBool( SENDINFO(m_AR1M1_GL_Loaded) ),
	SendPropBool( SENDINFO(m_SMG1_GL_action_failed) ),
	SendPropBool( SENDINFO(m_AR1M1_GL_action_failed) ),
#ifdef HL2_EPISODIC
...
BEGIN_SIMPLE_DATADESC( CHL2PlayerLocalData )
	...
	DEFINE_FIELD( m_SMG1_GL_Loaded, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_AR1M1_GL_Loaded, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_SMG1_GL_action_failed, FIELD_BOOLEAN ),
	DEFINE_FIELD( m_AR1M1_GL_action_failed, FIELD_BOOLEAN ),
#ifdef HL2_EPISODIC
...
CHL2PlayerLocalData::CHL2PlayerLocalData()
{
	...
	m_SMG1_GL_Loaded = false;
	m_AR1M1_GL_Loaded = false;
	m_SMG1_GL_action_failed = false;
	m_AR1M1_GL_action_failed = false;
#ifdef HL2_EPISODIC
