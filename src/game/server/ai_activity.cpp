...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_IRONSHOOT); //для прицеливания
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK_RELOAD);
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARY_RELOAD);
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD);
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_NOBOLD);
